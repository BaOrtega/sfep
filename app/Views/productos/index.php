                ...
                <div class="card-body p-4">
                    ...
                    <div class="stats-grid">
                        <div class="stat-card total">
                            ...
                            <div class="stat-number text-primary"><?= count($productos) ?></div>
                        ...
                        <div class="stat-card stock">
                            ...
                            <div class="stat-number text-success"><?= array_sum(array_column($productos, 'inventario')) ?></div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border-0" placeholder="Buscar productos por nombre o descripción...">
                                </div>
                            </div>
                            <div class="col-md-4">
    ...
    <script>
        ...
        document.querySelector('select').addEventListener('change', function(e) {
            ...
            rows.forEach(row => {
                ...
                if (filterValue === 'high' && !stockBadge.classList.contains('bg-success')) {
                    showRow = false;
                } else if (filterValue === 'low' && !stockBadge.classList.contains('bg-warning')) {
                    showRow = false;
                } else if (filterValue === 'out' && !stockBadge.classList.contains('bg-danger')) {
                    showRow = false;
                }
